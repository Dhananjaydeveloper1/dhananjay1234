...
import service.com.EmployeeService;
...
public class ManageEmployee {
	...
	//	Integer empID1 = employeeService.addEmployee("Dhananjay", "kumar", 1000);// asssinged values from here
	...
	//	listinfo.add(empID2);
		...
		try {
	//	employeeService.updateEmployeeDetails(4, 55);
		} catch (Exception e) {
		...
		try {
		employeeService.deleteEmployeeDetailsById(4, 55);
		} catch (Exception e) {
